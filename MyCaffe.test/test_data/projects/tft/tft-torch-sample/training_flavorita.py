...
data_path = 'data/favorita/data.small.10000.pickle'
...
configuration = {'optimization':
                 {
                     'batch_size': {'training': train_batch, 'inference': test_batch},
                     'learning_rate': 0.001,
                     'max_grad_norm': 0, #1.0,
                 }
                 ,
...
# The model also expects some meta data, specifying the structure of the input, including how many 
# variables compose each channel, the cadinalities for categorical variables (which require embedding
# layers). The meta data is also in the pickle file.
