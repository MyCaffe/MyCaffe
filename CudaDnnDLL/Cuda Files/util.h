...
const int ERROR_SSD_HOST_TYPE_NOT_SUPPORTED		= ERROR_SSD + 4;
const int ERROR_SSD_BAD_MATCH					= ERROR_SSD + 5;
const int ERROR_SSD_GT_LABEL_OUT_OF_RANGE		= ERROR_SSD + 6;
const int ERROR_SSD_PRIOR_VARIANCE_COUNT		= ERROR_SSD + 7;
const int ERROR_SSD_BACKGROUND_LABEL_OUT_OF_RANGE = ERROR_SSD + 8;
const int ERROR_SSD_COMPUTE_CONF_LOSS_MATCH_INDEX_INCORRECT = ERROR_SSD + 9;
const int ERROR_SSD_COMPUTE_CONF_LOSS_GT_MISSING_ITEM = ERROR_SSD + 10;
const int ERROR_SSD_COMPUTE_CONF_LOSS_MATCH_INDEX_OUT_OF_RANGE = ERROR_SSD + 11;
const int ERROR_SSD_COMPUTE_CONF_LOSS_INVALID_LABEL = ERROR_SSD + 12;
const int ERROR_SSD_NOT_SUPPORTED_IN_HALF_BBOX  = ERROR_SSD + 14;
const int ERROR_SSD_LOC_PRED_LABEL_NOT_FOUND    = ERROR_SSD + 15;
const int ERROR_SSD_CODE_TYPE_UNKNOWN			= ERROR_SSD + 16;
const int ERROR_SSD_SAMPLE_SIZE_TOO_SMALL		= ERROR_SSD + 17;
const int ERROR_SSD_INVALID_NUM_CLASSES			= ERROR_SSD + 18;
const int ERROR_SSD_CONF_LOSS_TYPE_UNKNOWN		= ERROR_SSD + 19;
const int ERROR_SSD_BACKGROUND_LABEL_IN_DATASET = ERROR_SSD + 20;
const int ERROR_SSD_NUMLOCCLASSES_INVALID_FOR_SHARED = ERROR_SSD + 21;
const int SSD_ERROR_LOCCOUNT_GTCOUNT_INCORRECT = ERROR_SSD + 22;
const int SSD_ERROR_LOC_LOSS_MATCH_COUNT_INCORRECT = ERROR_SSD + 23;
const int SSD_ERROR_INVALID_LOC_LOSS_TYPE		= ERROR_SSD + 24;
