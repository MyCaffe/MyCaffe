    ...
    public class VOCDataLoader
    {
        ...
        public void LoadDatabase()
        {
            try
            {
                ...
                int nIdx = 0;
                int nTotal = 17125 + 5011;
                int nExtractIdx = 0;
                int nExtractTotal = 40178 + 10935;
                Log log = new Log("VOC");
                ...
                if (!loadFile(m_param.DataBatchFile1, strSrc, nExtractTotal, ref nExtractIdx, nTotal, ref nIdx, log, m_param.ExtractFiles, rgNameToLabel))
                    return;

                if (!loadFile(m_param.DataBatchFile2, strSrc, nExtractTotal, ref nExtractIdx, nTotal, ref nIdx, log, m_param.ExtractFiles, rgNameToLabel))
                    return;
                ...
                if (!loadFile(m_param.DataBatchFile3, strSrc, nExtractTotal, ref nExtractIdx, nTotal, ref nIdx, log, m_param.ExtractFiles, rgNameToLabel))
                    return;
