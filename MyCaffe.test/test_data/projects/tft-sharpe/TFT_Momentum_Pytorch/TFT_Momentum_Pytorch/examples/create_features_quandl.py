...
from data.pull_data import pull_quandl_sample_data, pull_quandl_index_sample_data
...
def main(
    ...
    features = pd.concat(
        [
            deep_momentum_strategy_features(pull_quandl_sample_data(ticker), pull_quandl_index_sample_data("RIY")).assign(
                ticker=ticker
            )
