...
* Visual Studio 2022 & <a href="https://developer.nvidia.com/cuda-toolkit/whatsnew">CUDA 11.6.0</a> & <a href="https://developer.nvidia.com/cudnn">cuDnn 8.3.2</a> (current test pass)</br>
</br>

NOTE: Compute 5.3 and above required for CUDA 11.6.0/cuDNN 8.3.2 when using __half sized memory.
NOTE: Only compute 5.2 and above are supported in CUDA 11.6.0/cuDNN 8.3.2 due to 5.1 and lower compute phase-out in CUDA 11.6.
