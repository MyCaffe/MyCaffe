...
class Device
{
	...
	public:
		...
		//---------------------------------------------------------------------------
		//	Fused CuDNN Fused Computation functions
		//---------------------------------------------------------------------------

		long CreateFusedComp(long lInput, T* pfInput, long llInput, LONGLONG* plInput, long* plOutput, T** ppfOutput);
		long FreeFusedComp(long lInput, T* pfInput, long llInput, LONGLONG* plInput, long* plOutput, T** ppfOutput);
		long FusedCompAddTensor(long lInput, T* pfInput, long llInput, LONGLONG* plInput, long* plOutput, T** ppfOutput);
		long FusedCompGetTensor(long lInput, T* pfInput, long llInput, LONGLONG* plInput, long* plOutput, T** ppfOutput);
		...
		long cuda_muladd(long lInput, T* pfInput, long llInput, LONGLONG* plInput, long* plOutput, T** ppfOutput);
		long cuda_z_score(long lInput, T* pfInput, long llInput, LONGLONG* plInput, long* plOutput, T** ppfOutput);
		...
		long cuda_threshold(long lInput, T* pfInput, long llInput, LONGLONG* plInput, long* plOutput, T** ppfOutput);
		...
		long cuda_channel_sum2(long lInput, T* pfInput, long llInput, LONGLONG* plInput, long* plOutput, T** ppfOutput);
...
inline long Device<T>::CreateRope(long lInput, T* pfInput, long llInput, LONGLONG* plInput, long* plOutput, T** ppfOutput)
{
	...
	int nGpuID = (int)plInput[1];
	int nCount = (int)plInput[2];
	int nBatch = (int)plInput[3];
	int nSeqLen = (int)plInput[4];
	int nHeads = (int)plInput[5];
	int nDim = (int)plInput[6];
	T fTheta = pfInput[0];

	if (lErr = m_memory.CreateRope(nSharedIndex, nGpuID, nCount, nBatch, nSeqLen, nHeads, nDim, fTheta, &m_math, &hHandle))
		return lErr;
...
template <class T>
inline long Device<T>::CreateFusedComp(long lInput, T* pfInput, long llInput, LONGLONG* plInput, long* plOutput, T** ppfOutput)
{
	LONG lErr;
	long hHandle = 0;
	long hWorkspace = 0;
	...
	int nGpuID = (int)plInput[2];
	DataType dtIo = (DataType)(int)plInput[3];
	DataType dtIntermediate = (DataType)(int)plInput[4];
	DataType dtCompute = (DataType)(int)plInput[5];
	PreBuiltFusedComp preBuilt = PREBUILT_FUSED_COMP_NONE;
	
	if (llInput > 6)
		preBuilt = (PreBuiltFusedComp)(int)plInput[6];

	if (lErr = m_memory.CreateFusedComp(nSharedIndex, hCuda, nGpuID, dtIo, dtIntermediate, dtCompute, preBuilt, &m_math, &hHandle, &hWorkspace))
		return lErr;
...
template <class T>
inline long Device<T>::FreeFusedComp(long lInput, T* pfInput, long llInput, LONGLONG* plInput, long* plOutput, T** ppfOutput)
{
	LONG lErr;
	...
	return m_memory.FreeFusedComp(hHandle);
}

template <class T>
inline long Device<T>::FusedCompAddTensor(long lInput, T* pfInput, long llInput, LONGLONG* plInput, long* plOutput, T** ppfOutput)
{
	LONG lErr;
	long hHandle;
	...
	long nS2 = (long)plInput[3];
	long nS3 = (long)plInput[4];
	long nS4 = (long)plInput[5];
	bool bTranspose = (plInput[6] == 0) ? false : true;
	long hWorkspace = 0;

	if (lErr = m_memory.FusedCompAddTensor(hFusedComp, dt, nS1, nS2, nS3, nS4, bTranspose, &hHandle, &hWorkspace))
		return lErr;
...
template <class T>
inline long Device<T>::FusedCompGetTensor(long lInput, T* pfInput, long llInput, LONGLONG* plInput, long* plOutput, T** ppfOutput)
{
	LONG lErr;
	...
	if (lErr = m_memory.FusedCompGetTensor(hFusedComp, hTensorHandle, &dt, &nS1, &nS2, &nS3, &nS4, &bTranspose))
		return lErr;
...
template <class T>
inline long Device<T>::FusedCompAddOp(long lInput, T* pfInput, long llInput, LONGLONG* plInput, long* plOutput, T** ppfOutput)
{
	LONG lErr;
...
template <class T>
inline long Device<T>::FusedCompExecute(long lInput, T* pfInput, long llInput, LONGLONG* plInput, long* plOutput, T** ppfOutput)
{
	LONG lErr;
	...
	long lActualCount = lRemaining / 3;
