...
namespace MyCaffe.test
{
    ...
    class TransformInputsTest<T> : TestEx<T>, ITransformInputsTest
    {
        ...
        /// Run test_1_transforminputs.py on fresh 'test\iter_0' data
        /// 
        ...
        public void TestForward()
        {
            ...
            try
            {
                ...
                blob1.LoadFromNumpy(strPath + "tft.static.x_categorical.npy");

                blob1 = net.FindBlob("x_numeric_hist");
                blob1.LoadFromNumpy(strPath + "tft.historical.x_numeric.npy");
                blob1 = net.FindBlob("x_categorical_hist");
                blob1.LoadFromNumpy(strPath + "tft.historical.x_categorical.npy");

                blob1 = net.FindBlob("x_numeric_future");
                blob1.LoadFromNumpy(strPath + "tft.future.x_numeric.npy");
                blob1 = net.FindBlob("x_categorical_future");
                blob1.LoadFromNumpy(strPath + "tft.future.x_categorical.npy");
