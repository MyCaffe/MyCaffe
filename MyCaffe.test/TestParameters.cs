...
namespace MyCaffe.test
{
    ...
    public class TestParameters
    {
        ...
        {
            string str = "transform_param { scale: 0.5 mirror: True crop_size: 3 use_imagedb_mean: True force_color: True color_order: RGB mask_param { option { active: False } boundary_left: 0 boundary_right: 0 boundary_top: 0 boundary_bottom: 0 } label_mapping { option { active: False } } }";
