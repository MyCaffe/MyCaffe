...
#from test_transformer import TransformerEx
...
#            self.model.train()
            ...
            for i, batch in tqdm(enumerate(self.train_loader)):
                ...
                output = self.mycaffe.step(i, src_input, trg_input, trg_output, e_mask, d_mask)
                ...
                acc1 = self.mycaffe.current_accuracy()
                loss1 = self.mycaffe.current_loss()
                train_losses.append(loss1)
                train_accuracy.append(acc)                

                print(f" loss = {loss1}, accuracy = {acc}, mycaffe accuracy = {acc1}")
