...
To install and run <b>MyCaffe</b> you will need to do the following steps.  As a side note, we are using (and recommend) CUDA 11.1.1 with cuDNN 8.0.5 and Visual Studio 2019 on Windows 10 Pro for all of our testing.
</br>
<H3>I. CUDA - Install NVIDIA CUDA and cuDNN Libraries</H3>
Install CUDA 11.1.1 as shown below.
<H4>A. CUDA 11.1.1 - Install NVIDIA CUDA and cuDNN Libraries</H4>
1.) Install the NVIDIA CUDA 11.1.1 Toolkit for Windows 10 from https://developer.nvidia.com/cuda-downloads. 
</br>2.) Install the NVIDIA cuDNN 8.0.5 Accelerated Libraries for CUDA 11.1 on Windows 10 from https://developer.nvidia.com/cuDNN.
</br>3.) Create a new directory off your <b><i>$(CUDA_PATH_V11_1)</i></b> installation location named <b><i>cudann_11.1-win-v8.0.5.39</i></b> and copy the cuDNN <b><i>cudnn.h</i></b> and <b><i>cudnn.lib</i></b> files into it.
</br>4.) Copy the <b><i>cudnn64_8.dll</i></b> and associated DLL files into the <b><i>$(CUDA_PATH_V11_1)\bin</i></b> directory.
</br>5.) Install the NVIDIA NVAPI (r450) from https://developer.nvidia.com/nvapi.
</br>6.) Create a new directory off your <b><i>$(CUDA_PATH_V11_1)</i></b> installation location named <b><i>nvapi_450</i></b> and copy the NVAPI header and library files into it.
</br>
...
</br>The <b>CudaControl</b> uses the <b><i>CudaControl.pfx</i></b> located in the <b><i>packages\CudaControl.0.11.1.x\lib\Net40\</i></b> directory.  
...
<b><i>packages\CudaControl.0.11.1.x\lib\Net40\</i></b> directory, replacing the pfx file there.  Alternatively, you can just install 
...
</br>c.) nccl64_134.11.1.dll - If you plan on running multi-GPU training sessions, you will need the <b><i>nccl64_134.11.1.dll</i></b>, which must be placed
...
by the <b>CudaControl</b> NuGet package and placed in the <i>packages\CudaControl.0.11.1.x\lib\Net40</i> directory.  You should copy the library into
...
Before debugging, you will need to copy the CUDA files into your output target directory.  To do this, copy the '\Program Files\SignalPop\MyCaffe\cuda_11.1' folder to the 
