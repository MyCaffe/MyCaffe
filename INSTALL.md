...
To install and run <b>MyCaffe</b> you will need to do the following steps.  As a side note, we are using (and recommend) CUDA 11.0.3 with cuDNN 8.0.2 and Visual Studio 2017 on Windows 10 Pro for all of our testing.
</br>
