...
namespace MyCaffe.test
{
    ...
    public class TestParameters
    {
        ...
        {
            string str = "transform_param { scale: 0.5 mirror: True crop_size: 3 use_image_mean: True force_color: True }";
        ...
        {
            string str = "transform_param { scale: 3.5 mirror: True crop_size: 3 mean_value: 2 mean_value: 3 mean_value: 4 force_gray: True }";
            RawProto proto = RawProto.Parse(str).FindChild("transform_param");
            TransformationParameter p = TransformationParameter.FromProto(proto);
