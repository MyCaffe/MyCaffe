...
To install and run <b>MyCaffe</b> you will need to do the following steps.  As a side note, we are using (and recommend) CUDA 10.2.89 with cuDNN 7.6.5 and Visual Studio 2017 on Windows 10 Pro for all of our testing.
</br>
<H3>I. CUDA - Install NVIDIA CUDA and cuDNN Libraries</H3>
Install CUDA 10.2.89 as shown below.
<H4>A. CUDA 10.2.89 - Install NVIDIA CUDA and cuDNN Libraries</H4>
1.) Install the NVIDIA CUDA 10.2.89 Toolkit for Windows 10 from https://developer.nvidia.com/cuda-downloads. 
</br>2.) Install the NVIDIA cuDNN 7.6.5 Accelerated Libraries for CUDA 10.2 on Windows 10 from https://developer.nvidia.com/cuDNN.
</br>3.) Create a new directory off your <b><i>$(CUDA_PATH_V10_2)</i></b> installation location named <b><i>cudann_10.2-win-v7.6.5.32</i></b> and copy the cuDNN <b><i>cudnn.h</i></b> and <b><i>cudnn.lib</i></b> files into it.
</br>4.) Copy the <b><i>cudnn64_7.dll</i></b> file into the <b><i>$(CUDA_PATH_V10_2)\bin</i></b> directory.
</br>5.) Install the NVIDIA NVAPI (r435) from https://developer.nvidia.com/nvapi.
</br>6.) Create anew directory off your <b><i>$(CUDA_PATH_V10_2)</i></b> installation location named <b><i>nvapi_435</i></b> and copy the NVAPI header and library files into it.
</br>
...
</br>The <b>CudaControl</b> uses the <b><i>CudaControl.pfx</i></b> located in the <b><i>packages\CudaControl.0.10.2.x\lib\Net40\</i></b> directory.  
...
<b><i>packages\CudaControl.0.10.2.x\lib\Net40\</i></b> directory, replacing the pfx file there.  Alternatively, you can just install 
...
</br>c.) nccl64_134.10.2.dll - If you plan on running multi-GPU training sessions, you will need the <b><i>nccl64_134.10.2.dll</i></b>, which must be placed
...
by the <b>CudaControl</b> NuGet package and placed in the <i>packages\CudaControl.0.10.2.x\lib\Net40</i> directory.  You should copy the library into
