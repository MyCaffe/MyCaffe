...
const int CUDNN_FN_RNN8_IS_SUPPORTED = 150;
const int CUDNN_FN_RNN8_CREATE = 151;
const int CUDNN_FN_RNN8_FREE = 152;
const int CUDNN_FN_RNN8_SET = 153;
const int CUDNN_FN_RNN8_GET_MEMORY_SIZES = 154;
const int CUDNN_FN_RNN8_INIT_WEIGHTS = 155;
...
const int CUDA_FN_CPD_COMPUTE_T_VALUEAT = 183;
const int CUDA_FN_CPD_COMPUTE_S_VALUES = 184;
...
const int CUDA_FN_CHANNEL_STDEV = 288;
...
const int CUDA_FN_CHANNEL_MULV = 299;
...
const int CUDA_FN_CHANNEL_ADD = 304;
...
const int CUDA_FN_CHANNEL_SUM2 = 309;
const int CUDA_FN_CHANNEL_INTERPOLATE_LINEAR = 310;
...
const int CUDA_FN_NLLLOSS_FWD = 442;
const int CUDA_FN_NLLLOSS_BWD = 443;
...
const int CUDA_FN_MEAN_ERROR_LOSS_BWD = 495;

const int CUDA_FN_SIGMOID_CROSS_ENTROPY_FWD = 496;
const int CUDA_FN_SIGMOID_CROSS_ENTROPY_BWD = 497;
const int CUDA_FN_SOFTMAX_CROSS_ENTROPY_FWD = 498;
const int CUDA_FN_SOFTMAX_CROSS_ENTROPY_BWD = 499;
...
const int CUDA_FN_ADAMW_UPDATE = 506;
...
const int CUDA_FN_BCE_WITH_LOGITS_LOSS_FWD = 960;
const int CUDA_FN_BCE_WITH_LOGITS_LOSS_BWD = 961;

const int CUDA_FN_CREATE_LAYERNORM = 970;
const int CUDA_FN_FREE_LAYERNORM = 971;
...
const int CUDA_FN_CREATE_BLOBLOADER = 990;
const int CUDA_FN_FREE_BLOBLOADER = 991;
const int CUDA_FN_BLOBLOADER_LOAD = 992;
const int CUDA_FN_BLOBLOADER_RESETOFFSET = 993;
const int CUDA_FN_BLOBLOADER_ADDTOOFFSET = 994;

const int CUDNN_FN_CREATE_FUSED_COMP = 1001;
const int CUDNN_FN_FREE_FUSED_COMP = 1002;
const int CUDNN_FN_FUSED_COMP_ADD_TENSOR = 1003;
const int CUDNN_FN_FUSED_COMP_GET_TENSOR = 1004;
const int CUDNN_FN_FUSED_COMP_ADD_OP = 1005;
const int CUDNN_FN_FUSED_COMP_BUILD = 1006;
const int CUDNN_FN_FUSED_COMP_EXECUTE = 1007;

const int CUDA_FN_DEBUG = 10000;
