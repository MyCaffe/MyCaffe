...
class Device
{
	...
	public:
		...
		long cuda_mask_batch(long lInput, T* pfInput, long* plOutput, T** ppfOutput);
		...
		long cuda_channel_mulv(long lInput, T* pfInput, long* plOutput, T** ppfOutput);
		...
		long cuda_channel_fillfrom(long lInput, T* pfInput, long* plOutput, T** ppfOutput);
		long cuda_channel_copy(long lInput, T* pfInput, long* plOutput, T** ppfOutput);
		long cuda_channel_copyall(long lInput, T* pfInput, long* plOutput, T** ppfOutput);
		long cuda_channel_duplicate(long lInput, T* pfInput, long* plOutput, T** ppfOutput);
		...
		long cuda_gelu_fwd(long lInput, T* pfInput, long* plOutput, T** ppfOutput);
		long cuda_gelu_bwd(long lInput, T* pfInput, long* plOutput, T** ppfOutput);

		long cuda_serf_fwd(long lInput, T* pfInput, long* plOutput, T** ppfOutput);
		long cuda_serf_bwd(long lInput, T* pfInput, long* plOutput, T** ppfOutput);
...
template <class T>
inline long Device<T>::cuda_gelu_fwd(long lInput, T* pfInput, long* plOutput, T** ppfOutput)
{
	LONG lErr;
...
template <class T>
inline long Device<T>::cuda_gelu_bwd(long lInput, T* pfInput, long* plOutput, T** ppfOutput)
{
	LONG lErr;
...
template <class T>
inline long Device<T>::cuda_serf_fwd(long lInput, T* pfInput, long* plOutput, T** ppfOutput)
{
	LONG lErr;
...
template <class T>
inline long Device<T>::cuda_serf_bwd(long lInput, T* pfInput, long* plOutput, T** ppfOutput)
{
	LONG lErr;
