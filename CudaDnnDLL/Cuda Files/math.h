...
class Math
{
	...
	public:
		...
		long cuda_bce_with_logits_loss_fwd(int nCount, long hX, long hY, long hW, long hPosW, long hLossData, long hWork);
		long cuda_bce_with_logits_loss_bwd(int nCount, long hX, long hY, long hW, long hPosW, long hGrad);
