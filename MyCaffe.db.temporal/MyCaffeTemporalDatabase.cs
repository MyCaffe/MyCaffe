...
namespace MyCaffe.db.temporal
{
    ...
    public partial class MyCaffeTemporalDatabase : Component, IXTemporalDatabaseBase
    {
        ...
        public Tuple<DatasetDescriptor, int, int> CreateSimpleDirectStream(string strDsName, string strStrmName, SettingsCaffe s, PropertySet prop, PlotCollection plots, double dfTrainingSplitPct = 0.8, int nValIdx = -1)
        {
            ...
            int nItemIDTrain = AddDirectDatasetItemSet(dsd.TrainingSource.ID, "Data", dtStart, dtEnd, nSteps, rgStrm, 0, dsd.TrainingSource);
            ...
            int nItemIDTest = AddDirectDatasetItemSet(dsd.TestingSource.ID, "Data", dtStart, dtEnd, nSteps, rgStrm, 0, dsd.TestingSource);
        ...
        public int AddDirectDatasetItemSet(int nSrcID, string strName, DateTime dtStart, DateTime dtEnd, int nSteps, OrderedValueStreamDescriptorSet rgStrm, int nTargetStreamIdx, SourceDescriptor src = null)
        {
            ...
            return ts.AddDirectItemSet(m_random, vi, rgStrm, nTargetStreamIdx, src);
        }
...
#pragma warning disable 1591, 1587
        ...
        public SimpleDatum QueryItem(int nSrcId, int nIdx, DB_LABEL_SELECTION_METHOD? labelSelectionOverride = null, DB_ITEM_SELECTION_METHOD? imageSelectionOverride = null, int? nLabel = null, bool bLoadDataCriteria = false, bool bLoadDebugData = false, bool bThrowExceptions = true) /**@private */
        {
            return null;
        }

        public SimpleDatum QueryItem(int nSrcId, DateTime dt, DB_LABEL_SELECTION_METHOD? labelSelectionOverride = null, DB_ITEM_SELECTION_METHOD? imageSelectionOverride = null, int? nLabel = null, bool bLoadDataCriteria = false, bool bLoadDebugData = false, bool bThrowExceptions = true) /**@private */
        {
            return null;
        }
