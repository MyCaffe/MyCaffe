...
namespace MyCaffe.db.image
{
    ...
    public class DatabaseManagement
    {
        ...
        protected virtual void createTables(SqlConnection connection, bool bFullCreate, bool bUpdateOnly, bool bTemporalOnly = false)
        {
            ...
            cmdCreate = new SqlCommand(Properties.Resources.UpdateValueItemsTable3, connection);
            cmdCreate.ExecuteNonQuery();
            cmdCreate.Dispose();

            cmdCreate = new SqlCommand(Properties.Resources.UpdateRawImagesTable1, connection);
            cmdCreate.ExecuteNonQuery();
            cmdCreate.Dispose();
        }
