...
* Visual Studio 2022 & <a href="https://developer.nvidia.com/cuda-toolkit/whatsnew">CUDA 11.6.2</a> & <a href="https://developer.nvidia.com/cudnn">cuDnn 8.3.3</a> (current test pass)</br>
</br>

NOTE: Compute 5.3 and above required for CUDA 11.6.2/cuDNN 8.3.3 when using __half sized memory.
