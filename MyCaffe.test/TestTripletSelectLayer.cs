...
namespace MyCaffe.test
{
    ...
    class TripletSelectLayerTest<T> : TestEx<T>, ITripletSelectLayerTest
    {
        ...
        public void Fill(int nBatchSize)
        {
            ...
            DataTransformer<T> transformer = new DataTransformer<T>(m_cuda, m_log, transform_param, Phase.TRAIN, m_ds.TrainingSource.ImageChannels, m_ds.TrainingSource.ImageHeight, m_ds.TrainingSource.ImageWidth);
