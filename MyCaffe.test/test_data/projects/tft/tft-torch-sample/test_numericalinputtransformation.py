...
DebugFunction.trace(numeric_transform.module.numeric_projection_layers[0].weight.grad, "proj_layer.0.weight_grad")
DebugFunction.trace(numeric_transform.module.numeric_projection_layers[0].bias.grad, "proj_layer.0.bias_grad")
DebugFunction.trace(numeric_transform.module.numeric_projection_layers[1].weight.grad, "proj_layer.1.weight_grad")
DebugFunction.trace(numeric_transform.module.numeric_projection_layers[1].bias.grad, "proj_layer.1.bias_grad")
DebugFunction.trace(numeric_transform.module.numeric_projection_layers[2].weight.grad, "proj_layer.2.weight_grad")
DebugFunction.trace(numeric_transform.module.numeric_projection_layers[2].bias.grad, "proj_layer.2.bias_grad")
DebugFunction.trace(numeric_transform.module.numeric_projection_layers[3].weight.grad, "proj_layer.3.weight_grad")
DebugFunction.trace(numeric_transform.module.numeric_projection_layers[3].bias.grad, "proj_layer.3.bias_grad")
