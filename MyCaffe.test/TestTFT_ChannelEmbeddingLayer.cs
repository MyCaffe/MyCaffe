    ...
    class ChannelEmbeddingLayerTest<T> : TestEx<T>, IChannelEmbeddingLayerTest
    {
        ...
        public void TestBackward()
        {
            ...
            try
            {
                ...
                TopVec[0].LoadFromNumpy(strPath + "grad_hist_processed_input.npy", true);
